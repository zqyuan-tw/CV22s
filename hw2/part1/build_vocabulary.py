...
def build_vocabulary(image_paths, vocab_size):
    ...
    for path in image_paths:
        ...
        frames, descriptors = dsift(image=np.array(img_gray), step=[4, 4], fast=True)
        feature.append(descriptors)
    feature = np.concatenate(feature, axis=0, dtype=np.float32)
    vocab = kmeans(feature, vocab_size)
...
if __name__ == '__main__':
    vocab = build_vocabulary(["./p1_data/p1/train/Bedroom/image_0001.jpg"], 10)
    print(vocab)